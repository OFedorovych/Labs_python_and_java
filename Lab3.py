...
class Good:
    ...
    def __repr__(self):
        return repr((self._Good__price, self._Good__weight_in_grams, self.producer, self.country))


class Pump(Good):
    def __init__(self, price, weight_in_grams, producer, country, max_pressure, nippel_type):
        super().__init__(price, weight_in_grams, producer, country)
        self.max_pressure = max_pressure
        self.nippel_type = nippel_type

    def __repr__(self):
        return repr((self._Good__price, self._Good__weight_in_grams, self.producer, self.country, self.max_pressure, self.nippel_type))

class Multitool(Good):
    def __init__(self, price, weight_in_grams, producer, country, size_in_mm, number_of_tools):
         super().__init__(price, weight_in_grams, producer,  country)
         self.size_in_mm = size_in_mm
         self.number_of_tools = number_of_tools
    
    def __repr__(self):
        return repr((self._Good__price, self._Good__weight_in_grams, self.producer, self.country, self.size_in_mm, self.number_of_tools))

class Lamp(Good):
     def __init__(self, price, weight_in_grams, producer, country, number_of_LEDs, color_tempr_in_K, time_of_work_in_hours):
         super().__init__(price, weight_in_grams, producer, country)
     ...
     def __repr__(self):
        return repr((self._Good__price, self._Good__weight_in_grams, self.producer, self.country, self.number_of_LEDs, self.color_tempr_in_K, self.time_of_work_in_hours))
...
def main():
    ...
    search_by_producer(lamp_objects)
